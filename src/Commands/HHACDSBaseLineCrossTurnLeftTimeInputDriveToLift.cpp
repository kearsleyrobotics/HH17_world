...
#include "HHACDSBaseLineCrossTurnLeftTimeInputDriveToLift.h"
...
HHACDSBaseLineCrossTurnLeftTimeInputDriveToLift::HHACDSBaseLineCrossTurnLeftTimeInputDriveToLift() {
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        //AddSequential(new HHACTurnLeftTimeInput());
