...
#include "HHACDSBaseLineCrossTurnRightTimeInputDriveToLift.h"
...
HHACDSBaseLineCrossTurnRightTimeInputDriveToLift::HHACDSBaseLineCrossTurnRightTimeInputDriveToLift() {
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        //AddSequential(new HHACTurnRightTimeInput());
