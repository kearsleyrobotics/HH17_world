...
HHACTurnRight1::HHACTurnRight1(): Command() {
...
void HHACTurnRight1::Initialize() {
	SetTimeout(2.0);
	hHDegPast = false;
}

// Called repeatedly when this Command is scheduled to run
void HHACTurnRight1::Execute() {
...
bool HHACTurnRight1::IsFinished() {
	return (hHDegPast || IsTimedOut());
}

// Called once after isFinished returns true
void HHACTurnRight1::End() {

}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void HHACTurnRight1::Interrupted() {
